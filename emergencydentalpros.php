...
define('EDP_PLUGIN_VERSION', '0.3.4');
...
require_once EDP_PLUGIN_DIR . 'includes/class-edp-sheet-credentials.php';
require_once EDP_PLUGIN_DIR . 'includes/class-edp-sheet-api.php';
require_once EDP_PLUGIN_DIR . 'includes/class-edp-sheet-sync.php';
