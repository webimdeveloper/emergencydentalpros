...
final class EDP_Locations_List_Table extends WP_List_Table
{
    ...
    public function get_columns(): array
    {
        return [
            ...
            'google'      => __('Google Business', 'emergencydentalpros') . '<span class="dashicons dashicons-arrow-right-alt2 edp-stat-filter-arrow edp-col-arrow" aria-hidden="true"></span>',
            'override'    => __('Static Page', 'emergencydentalpros') . '<span class="dashicons dashicons-arrow-right-alt2 edp-stat-filter-arrow edp-col-arrow" aria-hidden="true"></span>',
